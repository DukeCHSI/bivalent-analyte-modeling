...
monoShort_mean <- mean(monoShort_MSE)
monoShort_sd <- sd(monoShort_MSE)
...
monoLong_mean <- mean(monoLong_MSE)
monoLong_sd <- sd(monoLong_MSE)
...
bulkshiftShort_mean <- mean(bulkshiftShort_MSE)
bulkshiftShort_sd <- sd(bulkshiftShort_MSE)
...
bulkshiftLong_mean <- mean(bulkshiftLong_MSE)
bulkshiftLong_sd <- sd(bulkshiftLong_MSE)
...
bivalentShort_mean <- mean(bivalentShort_MSE)
bivalentShort_sd <- sd(bivalentShort_MSE)
...
bivalentLong_mean <- mean(bivalentLong_MSE)
bivalentLong_sd <- sd(bivalentLong_MSE)
...
biva_name <- rep("BA Model", length(bivalentShort_MSE))
...
short_df <- rbind(monoShort_df, bulkShort_df, bivaShort_df)
...
biva_name <- rep("BA Model", length(bivalentLong_MSE))
...
long_df <- rbind(monoLong_df, bulkLong_df, bivaLong_df)
