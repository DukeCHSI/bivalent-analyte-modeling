...
fit_association_dissociation <- function(well_idx, sample_info, x_vals, y_vals,
  ...
  write_csv(full_param_table, paste('~/Summer2022/project/hiv-summer-2022/paper_codes/param_table_new/full_param',as.character(well_idx),'.csv',sep=''))
...
plot_sensorgrams_with_fits <- function(well_idx, sample_info, fits, x_vals, y_vals, 
  ...
  sub_title <- paste("Bivalent Analyte Model-2 with Extended Length of Dissociation")
