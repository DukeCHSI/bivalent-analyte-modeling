...
if choose_kd2 == 12
    kd2 = 3e-12; %1.75e-3;
    save_file_name = strcat('generated_data_N5_1400T/data_12.mat');
elseif choose_kd2 == 5
    kd2 = 3e-5;
    save_file_name = strcat('generated_data_N5_1400T/data_5.mat');
elseif choose_kd2 == 4
    kd2 = 3e-4;
    save_file_name = strcat('generated_data_N5_1400T/data_4.mat');
elseif choose_kd2 == 3
    kd2 = 3e-3;
    save_file_name = strcat('generated_data_N5_1400T/data_3.mat');
elseif choose_kd2 == 2
    kd2 = 3e-2;
    save_file_name = strcat('generated_data_N5_1400T/data_2.mat');
else
    kd2 = 3e-1;
    save_file_name = strcat('generated_data_N5_1400T/data_1.mat');
end
...
t_asc = 120:2:420;
t_dis = 423:2:1400; %423:10:4000; %423:5:1400; %423:30:7200;
t = [t_asc, t_dis];
...
for i=1:length(concs)
    ...
    scatter(t, output(:,i),'MarkerFaceColor',[0 0 0], 'MarkerEdgeColor',[0 0 0])
end
...
for i=1:length(concs)
    scatter(Time(:,i),RU(:,i),'MarkerFaceColor',[0.7 .7 .7])
end
