...
Rmaxs = 600+0*[7.57e+02 6.67e+02 6.25e+02 6.43e+02 7.07e+02];
...
t_stars = [2.83e+02 3.00e+02 2.82e+02 2.22e+02 1.45e+02];
...
sigma = noise_level;
save('profile_data/BA1_noisy_data_2200.mat','t','output','ka1','ka2','kd1','kd2','R0s','t_stars','Rmaxs','concs','t_asc','t_dis','sigma')
...
xline(t(121),'k--','LineWidth',2)
legend(strcat('k_{d2}=',num2str(kd2_1,'%.2e')),'','','','',strcat('k_{d2}=',num2str(kd2_2,'%.2e')),'','','','','','Location','Southeast')
[~,~] = title('Bivalent Analyte Model-1: Noisy Simulations for Extended Dissociation Length');%,...
